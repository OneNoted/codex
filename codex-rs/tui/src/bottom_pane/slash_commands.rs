...
mod tests {
    ...
    #[test]
    fn settings_command_exact_lookup_stays_available_when_realtime_is_disabled() {
        let mut flags = all_enabled_flags();
        flags.realtime_conversation_enabled = false;
        assert_eq!(
    ...
    #[test]
    fn settings_command_exact_lookup_stays_available_when_audio_device_selection_is_disabled() {
        assert_eq!(
