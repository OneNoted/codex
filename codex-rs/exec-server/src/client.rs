...
struct OrderedSessionEvents {
    ...
    // Server-side output, exit, and closed notifications can be emitted by
    // different tasks. Keep higher sequence numbers here until the missing
    // lower sequence numbers arrive.
